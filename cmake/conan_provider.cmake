...
macro(conan_provide_dependency package_name)
    message(STATUS "conan_provide_dependency called")
    ...
    if(NOT CONAN_INSTALL_SUCCESS)
        ...
        message(STATUS "CMake-Conan: conan minimum version: ${CONAN_MINIMUM_VERSION}, current version: ${CONAN_CURRENT_VERSION}")
        message(STATUS "CMake-Conan: first find_package() found. Installing dependencies with Conan")

        # (TODO): run 'conan config install' and set conan remote and conan user
    ...
    message(STATUS "CMake-Conan: CMAKE_MODULE_PATH: ${CMAKE_MODULE_PATH}")
    message(STATUS "CMake-Conan: CMAKE_PREFIX_PATH: ${CMAKE_PREFIX_PATH}")
